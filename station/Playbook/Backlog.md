...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — shipped v0.4.3 (absolute install-time paths baked into hook commands), PRs #105/#106, 2026-05-13. Resolved — removed from P0 2026-07-22 (backlog-hygiene). -->
...
<!-- "[feature] bonsai init/add non-interactive flags" — shipped v0.4.2 (--non-interactive --from-config, JSONL stdout, exit codes 0/2/3/4), Plan 39 PR #102, 2026-05-13. Resolved — removed from P0 2026-07-22 (backlog-hygiene). -->

## P1 — High

<!-- "[feature] Full agent-drivable CLI parity: init/update/add/remove" — resolved by Plan 41 (shipped 2026-06-16): all 4 cmds have *Result headless cores + JSONL/exit contract (ExitConflict=5); list --json; docs/agent-interface.md. PRs #120/#122/#123/#121/#125. Removed from P1 2026-07-22 (backlog-hygiene). -->
