...
<!-- [bug] Sensor hook commands use $PWD-walk-up — resolved via v0.4.3 (PRs #105/#106, 2026-05-13). Absolute install-time path baked into each hook command. Confirmed removed 2026-06-15 backlog-hygiene. -->
...
<!-- [feature] bonsai init / bonsai add need non-interactive flags — resolved via v0.4.2 (--non-interactive --from-config shipped). Superseded by P1 full CLI parity item (Plan 41). Confirmed removed 2026-06-15 backlog-hygiene. -->

## P1 — High

<!-- [feature] Full agent-drivable (non-interactive) CLI parity — SHIPPED via Plan 41 (PRs #120/#122/#123/#121/#125, 2026-06-16). All 4 cmds have headless cores + JSONL/exit contract. Confirmed removed 2026-06-15 backlog-hygiene. -->
