...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED v0.4.3 (2026-05-13, PRs #105/#106): hook commands now bake absolute install-time project root. Removed backlog-hygiene 2026-09-13. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — RESOLVED v0.4.2 (2026-05-13, PR #102): --non-interactive + --from-config shipped for init + add. Removed backlog-hygiene 2026-09-13. -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity" — RESOLVED by Plan 41 (2026-06-16, PRs #120/#122/#123/#121/#125): every mutating cmd (init/add/update/remove) has a headless *Result core + JSONL/exit contract. Removed backlog-hygiene 2026-09-13. -->
