...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — resolved in v0.4.3 (2026-05-13): generator now bakes absolute install-time project root into hook commands; existing projects need `bonsai update` to refresh. Removed from P0 by backlog-hygiene 2026-07-12. -->
...
<!-- "[feature] bonsai init/add need non-interactive flags [Plan 38 P2 blocker]" — resolved by v0.4.2 (2026-05-13): --non-interactive + --from-config shipped for init + add; Plan 41 (2026-06-16) extended full headless contract to update + remove. Removed from P0 by backlog-hygiene 2026-07-12. -->

## P1 — High

<!-- "[feature] Full agent-drivable CLI parity: init / update / add / remove" — resolved by Plan 41 (2026-06-16): all 4 commands have headless *Result cores + JSONL/exit contract (ExitConflict=5); list --json; docs/agent-interface.md contract doc shipped. Removed from P1 by backlog-hygiene 2026-07-12. -->
