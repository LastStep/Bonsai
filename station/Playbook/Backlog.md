...
<!-- [bug] Sensor hook commands use $PWD-walk-up — RESOLVED by v0.4.3 hotfix (2026-05-13, PR #105/#106). Hook commands now bake install-time absolute paths into .claude/settings.json. Existing projects need `bonsai update` to refresh. (backlog-hygiene cleanup 2026-07-08) -->
...
<!-- [feature] bonsai init / bonsai add non-interactive flags [Plan 38 P2 blocker] — RESOLVED by v0.4.2 (2026-05-13, PR #102). --non-interactive + --from-config shipped for init and add. (backlog-hygiene cleanup 2026-07-08) -->

## P1 — High

<!-- [feature] Full agent-drivable CLI parity: init / update / add / remove — RESOLVED by Plan 41 (2026-06-16, PRs #120/#122/#123/#121/#125). All four commands have headless *Result cores + JSONL/exit contract (ExitConflict=5); list --json; docs/agent-interface.md contract doc. (backlog-hygiene cleanup 2026-07-08) -->
