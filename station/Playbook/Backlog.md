...
<!-- "[bug] Sensor hook commands use $PWD-walk-up — breaks in multi-.bonsai.yaml setups" — resolved in v0.4.3 hotfix (Status.md 2026-05-13): hook commands now bake install-time absolute paths. Existing projects need `bonsai update` to refresh. Removed by backlog-hygiene 2026-07-10. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags [Plan 38 P2 blocker]" — resolved in v0.4.2 (Status.md 2026-05-13): --non-interactive + --from-config shipped for both init and add. Removed by backlog-hygiene 2026-07-10. -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — resolved in Plan 41 (Status.md 2026-06-16): all 4 mutating cmds now have pure *Result headless cores + JSONL/exit contract (ExitConflict=5); docs/agent-interface.md contract doc shipped. Removed by backlog-hygiene 2026-07-10. -->
