...
<!-- "[bug] Sensor hook commands use $PWD-walk-up — breaks in multi-.bonsai.yaml setups" — resolved in v0.4.3 (2026-05-13) via PRs #105/#106; hooks now bake absolute install-time path. Existing projects need `bonsai update`. Removed 2026-08-04 (backlog-hygiene). -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags [Plan 38 P2 blocker]" — resolved in v0.4.2 (2026-05-13); --non-interactive + --from-config added to cmd/init.go + cmd/add.go with JSONL stdout + exit codes. Removed 2026-08-04 (backlog-hygiene). -->

## P1 — High

<!-- "[feature] Full agent-drivable CLI parity: init / update / add / remove" — resolved via Plan 41 (2026-06-16, PRs #120/#122/#123/#121/#125): all 4 mutating cmds have headless *Result cores + JSONL/exit-code contract (ExitConflict=5); `list --json`; contract doc at docs/agent-interface.md. Removed 2026-08-04 (backlog-hygiene). -->
