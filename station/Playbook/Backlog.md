...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — resolved by v0.4.3 hotfix (PR #105/#106, commit 584b82b). Absolute install-time paths now baked into each hook command. Confirmed in Status.md Recently Done 2026-05-13. Removed 2026-07-30 (backlog-hygiene). -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — resolved by v0.4.2 (PR #102, commit 410a5f1). Both --non-interactive and --from-config flags shipped. Confirmed in Status.md Recently Done 2026-05-13. Removed 2026-07-30 (backlog-hygiene). -->

## P1 — High

<!-- "[feature] Full agent-drivable CLI parity: init / update / add / remove" — resolved by Plan 41 (PRs #120/#122/#123/#121/#125, commit ab202c3). All 4 mutating commands have headless cores + JSONL/exit contract; list --json added; docs/agent-interface.md contract doc shipped. Confirmed in Status.md Recently Done 2026-06-16. Removed 2026-07-30 (backlog-hygiene). -->
