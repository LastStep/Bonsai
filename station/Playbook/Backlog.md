...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED: shipped v0.4.3 (PR #105/#106, 2026-05-13). Removed from backlog 2026-08-18 backlog-hygiene. -->
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — RESOLVED: shipped v0.4.2 (PR #102, 2026-05-13). Removed from backlog 2026-08-18 backlog-hygiene. -->
...
<!-- "[feature] Full agent-drivable (non-interactive) CLI parity" — RESOLVED: shipped Plan 41 (PRs #120-#125, 2026-06-16). Every mutating cmd (init/add/update/remove) has a pure *Result headless core + JSONL/exit contract. Removed from backlog 2026-08-18 backlog-hygiene. -->
