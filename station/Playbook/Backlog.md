...
<!-- [feature] bonsai init / bonsai add need non-interactive flags — resolved 2026-05-13 via Plan 39 / v0.4.2 release. --non-interactive + --from-config flags shipped in cmd/init.go and cmd/add.go. -->
