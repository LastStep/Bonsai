...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — resolved v0.4.3 (2026-05-13). Removed 2026-09-14 backlog-hygiene. -->
<!-- "[feature] bonsai init/add need non-interactive flags" — resolved v0.4.2 (2026-05-13). Removed 2026-09-14 backlog-hygiene. -->

_(no active P0 items)_

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity" — resolved Plan 41 (2026-06-16): all four cmds (init/add/update/remove) ship *Result headless cores + JSONL/exit contract. Removed 2026-09-14 status-hygiene. -->
