...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED 2026-05-13: baked absolute install-time project root into hook commands. Shipped v0.4.3 (PR #105/#106). Resolved 2026-06-21 backlog-hygiene. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — RESOLVED 2026-05-13: --non-interactive + --from-config shipped in v0.4.2 (PR #102). Plan 41 further extended full headless parity to update/remove. Resolved 2026-06-21 backlog-hygiene. -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — RESOLVED 2026-06-16: Plan 41 shipped full headless CLI contract across all four commands (PRs #120/#122/#123/#121/#125, main ab202c3). Pure *Result headless cores + JSONL/exit contract (ExitConflict=5); list --json; docs/agent-interface.md contract doc. Resolved 2026-06-21 backlog-hygiene. -->
