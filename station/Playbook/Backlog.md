...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED 2026-05-13 via v0.4.3 hotfix (PRs #105/#106). Absolute install-time paths now baked into hook commands. Removed from backlog 2026-06-18 (backlog-hygiene routine). -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — RESOLVED 2026-05-13 via v0.4.2 release (PR #102). --non-interactive + --from-config flags shipped. Removed from backlog 2026-06-18 (backlog-hygiene routine). -->

_(P0 section clear — no critical blockers)_

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — RESOLVED 2026-06-16 via Plan 41 (PRs #120/#122/#123/#121/#125, main ab202c3). All four mutating cmds have headless *Result cores + JSONL/exit contract. Removed from backlog 2026-06-18 (backlog-hygiene routine). -->
