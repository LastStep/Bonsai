...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — resolved by v0.4.3 (2026-05-13). Sensor hook commands now bake install-time absolute paths. Removed from Backlog 2026-07-24 (backlog-hygiene). -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — resolved by v0.4.2 (2026-05-13). --non-interactive + --from-config flags shipped via Plan 39. Removed from Backlog 2026-07-24 (backlog-hygiene). -->

_(No open P0 items — see Status.md for active work.)_

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — resolved by Plan 41 (2026-06-16, PRs #120/#122/#123/#121/#125). Every mutating cmd has a pure *Result headless core + JSONL/exit contract. Removed from Backlog 2026-07-24 (backlog-hygiene). MCP server fast-follow tracked separately as Plan 42. -->
