...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — resolved v0.4.3 (2026-05-13, PR #105/#106, commit 584b82b). Hook commands now bake install-time absolute paths. Existing projects need bonsai update. Removed from P0 by backlog-hygiene 2026-08-02. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — resolved v0.4.2 (2026-05-13, PR #102, commit 410a5f1). --non-interactive --from-config <path> shipped; JSONL stdout + exit codes 0/2/3/4. Unblocked Plan 38 P2 rung-3. Removed from P0 by backlog-hygiene 2026-08-02. -->

## P1 — High

<!-- "[feature] Full agent-drivable CLI parity: init / update / add / remove" — resolved Plan 41 (2026-06-16, PRs #120/#122/#123/#121/#125, main ab202c3). Every mutating cmd has a pure *Result headless core + JSONL/exit contract (ExitConflict=5); list --json; docs/agent-interface.md contract doc. Removed from P1 by backlog-hygiene 2026-08-02. -->
