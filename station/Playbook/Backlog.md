...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED 2026-05-13 by v0.4.3 hotfix (PR #105/#106, commit 584b82b). Hook commands now bake absolute install-time paths. Existing projects need `bonsai update`. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — RESOLVED 2026-05-13 by v0.4.2/Plan 39 (PR #102). --non-interactive + --from-config shipped for both commands. -->

- **[ops] HOMEBREW_TAP_TOKEN PAT OVERDUE — rotate immediately** — Rotated 2026-04-22; 90-day expiry = expired ~2026-07-21. Today is 2026-07-31 — 10 days past expiry. Any release attempt will fail at GoReleaser brew step (`401 Bad credentials`). Action: rotate PAT, `gh secret set HOMEBREW_TAP_TOKEN --repo LastStep/Bonsai`. See v0.2.0 session notes for recovery steps. *(added 2026-04-22, escalated to P0 2026-07-31 by backlog-hygiene routine)*

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity" — RESOLVED 2026-06-16 by Plan 41 (PRs #120/#122/#123/#121/#125, main ab202c3). All four cmds (init/add/update/remove) have headless *Result cores + JSONL/exit-code contract (ExitConflict=5); list --json also shipped. MCP server next = Plan 42. -->
<!-- "[ops] HOMEBREW_TAP_TOKEN PAT expiry calendar reminder" — ESCALATED to P0 2026-07-31 (PAT expired ~2026-07-21, 10 days overdue). See P0 section. -->
