...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED: fixed in v0.4.3 (PRs #105/#106, 2026-05-13). Both repos hotfixed; bonsai update refreshes new absolute-path hook format. Removed by backlog-hygiene 2026-06-19. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags [Plan 38 P2 blocker]" — RESOLVED: shipped in v0.4.2 (PR #102, 2026-05-13) as --non-interactive + --from-config flags. Removed by backlog-hygiene 2026-06-19. -->

## P1 — High

<!-- [feature] Full agent-drivable (non-interactive) CLI parity — RESOLVED: shipped in Plan 41 (PRs #120/#122/#123/#121/#125, 2026-06-16). Every mutating cmd (init/add/update/remove) now has a pure *Result headless core + JSONL/exit contract. MCP server fast-follow = Plan 42. Removed by status-hygiene 2026-06-19. -->
