...
<!-- "[bug] Sensor hook commands use `$PWD`-walk-up" — RESOLVED v0.4.3 (PR #105/#106, 2026-05-13). Sensor hook commands now bake install-time absolute paths. Removed from Backlog by backlog-hygiene routine 2026-09-05. -->
...
<!-- "[feature] `bonsai init` / `bonsai add` need non-interactive flags" — RESOLVED v0.4.2 (PR #102, 2026-05-13). `--non-interactive --from-config` shipped for both commands. Removed from Backlog by backlog-hygiene routine 2026-09-05. -->

*(P0 section clear — all items resolved or promoted)*
