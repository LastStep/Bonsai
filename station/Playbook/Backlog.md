...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED 2026-05-13 via v0.4.3 hotfix (PRs #105/#106). Hooks now bake absolute install-time paths. Existing projects need `bonsai update`. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — RESOLVED 2026-05-13 via v0.4.2 (Plan 39, PR #102). --non-interactive + --from-config shipped for both commands. -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — RESOLVED 2026-06-16 via Plan 41 (PRs #120/#122/#123/#121/#125, main ab202c3). All 4 commands have pure *Result headless cores + JSONL/exit contract. MCP server = fast-follow Plan 42. -->
