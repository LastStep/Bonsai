...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — resolved v0.4.3 (PR #105/#106, Status.md Recently Done 2026-05-13). Absolute install-time paths now baked into hook commands. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — resolved v0.4.2 (Status.md 2026-05-13). --non-interactive + --from-config shipped in cmd/init.go + cmd/add.go. -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — resolved Plan 41 (PRs #120/#122/#123/#121/#125, Status.md 2026-06-16). All four cmds have headless cores + JSONL/exit contract; list --json; docs/agent-interface.md shipped. -->
