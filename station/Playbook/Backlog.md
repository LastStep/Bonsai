...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED in v0.4.3 (Status.md 2026-05-13). Hook commands now bake install-time absolute paths. Existing projects need `bonsai update` to refresh. (removed by backlog-hygiene 2026-07-16) -->
...
<!-- "[feature] `bonsai init` / `bonsai add` need non-interactive flags" — RESOLVED in v0.4.2 (Status.md 2026-05-13). `--non-interactive --from-config` shipped for both commands. Superseded also by Plan 41 full headless parity. (removed by backlog-hygiene 2026-07-16) -->

_(No active P0 items — see HTML comments above for recently resolved entries.)_

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — RESOLVED in Plan 41 (Status.md 2026-06-16). All 4 cmds have pure `*Result` headless cores + JSONL/exit contract. (removed by backlog-hygiene 2026-07-16) -->
