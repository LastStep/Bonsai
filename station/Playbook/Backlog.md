...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED 2026-05-13 by v0.4.3 hotfix (PRs #105/#106). Hook commands now bake install-time absolute paths into .claude/settings.json. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — RESOLVED 2026-05-13 by v0.4.2 (PR #102). --non-interactive + --from-config flags shipped for both commands. -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — RESOLVED 2026-06-16 by Plan 41 (PRs #120/#122/#123/#121/#125). All four mutating commands have pure *Result headless cores + JSONL/exit contract; list --json; docs/agent-interface.md published. Residual debt (unify remove cinematic/headless logic) captured in P2 below. -->
