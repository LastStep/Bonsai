...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED: shipped v0.4.3 hotfix 2026-05-13 (PR #105/#106). Hook commands now bake absolute install-time paths. Removed from active P0 2026-08-19 (backlog-hygiene). -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — RESOLVED: shipped v0.4.2 2026-05-13 (--non-interactive + --from-config + JSONL stdout + exit codes). Removed from active P0 2026-08-19 (backlog-hygiene). -->

## P1 — High

<!-- "[feature] Full agent-drivable CLI parity" — RESOLVED: Plan 41 shipped 2026-06-16 (PRs #120/#122/#123/#121/#125). All four cmds (init/add/update/remove) have headless *Result cores + JSONL/exit contract. Removed from active P1 2026-08-19 (backlog-hygiene). -->

- **[ops] HOMEBREW_TAP_TOKEN PAT EXPIRED — rotate immediately before next release** — PAT rotated 2026-04-22 (90-day expiry); deadline was ~2026-07-15; now ~2026-08-19 (~35 days overdue). Next release will fail at GoReleaser brew step with `401 Bad credentials`. Rotate via GitHub Settings → Developer Settings → Fine-grained tokens, then `gh secret set HOMEBREW_TAP_TOKEN --repo LastStep/Bonsai`. Same applies to any other repo PATs. *(added 2026-04-22, updated + flagged overdue 2026-08-19 by backlog-hygiene)*
