...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED v0.4.3 (PR #105/#106, 2026-05-13). Absolute install-time path baked into hook commands. Existing projects need `bonsai update` to refresh. Removed from P0 by backlog-hygiene 2026-06-26. -->
...
<!-- "[feature] `bonsai init` / `bonsai add` need non-interactive flags" — RESOLVED v0.4.2 (PR #102, 2026-05-13). `--non-interactive --from-config <path>` shipped for both commands. Superseded by Plan 41 full headless contract. Removed from P0 by backlog-hygiene 2026-06-26. -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — RESOLVED Plan 41 (PRs #120/#122/#123/#121/#125, 2026-06-16). All four commands have headless cores + JSONL/exit contract (ExitConflict=5); `list --json`. Removed from P1 by backlog-hygiene 2026-06-26. -->
