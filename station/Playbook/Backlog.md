...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED 2026-05-13 by v0.4.3 hotfix (sensor hook commands now bake install-time absolute paths). Removed 2026-08-31 backlog-hygiene. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — RESOLVED 2026-05-13 by v0.4.2 (--non-interactive --from-config shipped for init+add). Removed 2026-08-31 backlog-hygiene. -->

_(no active P0 items — all resolved or promoted)_

## P1 — High

<!-- "[feature] Full agent-drivable non-interactive CLI parity" — RESOLVED 2026-06-16 by Plan 41 (headless *Result cores + JSONL/exit contract for all four commands; docs/agent-interface.md). Removed 2026-08-31 backlog-hygiene. -->
