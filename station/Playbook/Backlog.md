...
<!-- Resolved 2026-05-13 — v0.4.3 hotfix (PR #105/#106, commit 584b82b) baked install-time absolute paths into sensor hook commands, eliminating the $PWD-walk-up cross-project drift. Removed from active backlog 2026-08-29 (backlog-hygiene). -->
...
<!-- Resolved 2026-05-13 — v0.4.2 release (PR #102, commit 410a5f1) shipped --non-interactive + --from-config flags for bonsai init and bonsai add. Removed from active backlog 2026-08-29 (backlog-hygiene). -->

## P1 — High

<!-- Resolved 2026-06-16 — Plan 41 (PRs #120/#122/#123/#121/#125, main ab202c3) shipped headless *Result cores + JSONL/exit contract (ExitConflict=5) for all four commands (init/add/update/remove) plus list --json + docs/agent-interface.md contract doc. Removed from active backlog 2026-08-29 (backlog-hygiene). -->
