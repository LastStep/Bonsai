...
<!-- [bug] Sensor hook commands $PWD-walk-up — resolved by v0.4.3 hotfix (absolute install-time paths baked into .claude/settings.json, PR #105/#106, 2026-05-13). Removed 2026-07-02 backlog-hygiene. -->
...
<!-- [feature] Non-interactive flags for bonsai init/add — resolved by v0.4.2 (--non-interactive + --from-config shipped, PR #102, 2026-05-13). Removed 2026-07-02 backlog-hygiene. -->

## P1 — High

<!-- [feature] Full agent-drivable CLI parity — resolved by Plan 41 (headless *Result cores + JSONL/exit contract for all 4 commands, ExitConflict=5, list --json, docs/agent-interface.md, PRs #120–#125, 2026-06-16). Removed 2026-07-02 backlog-hygiene. -->
