...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — resolved: absolute paths baked at install time. Shipped v0.4.3 (PR #105/#106, 2026-05-13). Cleared by backlog-hygiene 2026-08-30. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — resolved: --non-interactive + --from-config shipped in v0.4.2 (PR #102, 2026-05-13). Cleared by backlog-hygiene 2026-08-30. -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — resolved: Plan 41 shipped headless *Result cores + JSONL/exit contract for all 4 commands (PRs #120-#125, 2026-06-16). Cleared by backlog-hygiene 2026-08-30. -->
