...
<!-- [bug] Sensor hook commands use `$PWD`-walk-up — RESOLVED 2026-05-13 via v0.4.3 (PR #105/#106). Sensor hook commands now bake install-time absolute paths in .claude/settings.json. Existing projects need `bonsai update` to refresh. (added 2026-05-13, removed backlog-hygiene 2026-07-07) -->
...
<!-- [feature] `bonsai init` / `bonsai add` need non-interactive flags — RESOLVED 2026-05-13 via v0.4.2 (PR #102). `--non-interactive` + `--from-config <path>` shipped for both commands with JSONL stdout + exit codes 0/2/3/4. (added 2026-05-08, removed backlog-hygiene 2026-07-07) -->

## P1 — High

<!-- [feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove — RESOLVED 2026-06-16 via Plan 41 (PRs #120/#122/#123/#121/#125, main ab202c3). All four mutating cmds have pure *Result headless cores + JSONL/exit contract (ExitConflict=5); list --json; docs/agent-interface.md shipped. (added 2026-06-13, removed backlog-hygiene 2026-07-07) -->
