...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — resolved 2026-05-13 via v0.4.3 (PR #105/#106). Hook commands now bake absolute install-time project root. `bonsai update` refreshes existing installs. -->
