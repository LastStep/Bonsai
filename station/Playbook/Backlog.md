...
<!-- [bug] Sensor hook commands use $PWD-walk-up — RESOLVED by v0.4.3 hotfix (shipped 2026-05-13, Status.md Recently Done). Absolute install-time paths now baked into hook commands. Removed by backlog-hygiene 2026-09-18. -->
...
<!-- [feature] bonsai init / bonsai add need non-interactive flags — RESOLVED by v0.4.2 (shipped 2026-05-13) and superseded by Plan 41 headless CLI contract (shipped 2026-06-16, Status.md Recently Done). Removed by backlog-hygiene 2026-09-18. -->

_(no open P0 items)_

## P1 — High

<!-- [feature] Full agent-drivable (non-interactive) CLI parity — RESOLVED by Plan 41 (shipped 2026-06-16, Status.md Recently Done). All mutating cmds (init/add/update/remove) now have pure *Result headless cores + JSONL/exit contract. Removed by backlog-hygiene 2026-09-18. -->
