...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED by v0.4.3 (2026-05-13, PR #105/#106). Hooks now bake absolute install-time project root into .claude/settings.json. Existing projects need `bonsai update` to refresh. (removed from backlog 2026-09-03 backlog-hygiene) -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — RESOLVED by v0.4.2 (2026-05-13, PR #102). --non-interactive + --from-config shipped; unblocked Plan 38 P2 rung-3. (removed from backlog 2026-09-03 backlog-hygiene) -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — RESOLVED by Plan 41 (2026-06-16, PRs #120/#122/#123/#121/#125). Every mutating cmd (init/add/update/remove) has a pure *Result headless core + JSONL/exit contract (ExitConflict=5); list --json; docs/agent-interface.md contract doc. (removed from backlog 2026-09-03 backlog-hygiene) -->
