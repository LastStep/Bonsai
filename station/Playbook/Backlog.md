...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — resolved v0.4.3 / PR #105+#106 / 2026-05-13. Hook commands now bake install-time absolute project root. (backlog-hygiene 2026-08-08) -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — resolved v0.4.2 / PR #102 / 2026-05-13. --non-interactive + --from-config shipped for both commands. (backlog-hygiene 2026-08-08) -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — resolved Plan 41 / PRs #120–#125 / 2026-06-16. All 4 commands have headless *Result cores + JSONL/exit contract (ExitConflict=5); list --json; contract doc at docs/agent-interface.md. (backlog-hygiene 2026-08-08) -->
