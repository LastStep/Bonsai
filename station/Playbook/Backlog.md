...
<!-- [bug] Sensor hook $PWD-walk-up — resolved 2026-05-13 via v0.4.3 (PRs #105/#106). Hook commands now bake install-time absolute paths; existing projects need `bonsai update`. -->
...
<!-- [feature] bonsai init/add non-interactive flags — resolved 2026-05-13 via v0.4.2 (--non-interactive --from-config, JSONL stdout, exit codes 0/2/3/4). Unblocked Plan 38 P2 rung-3. -->

## P1 — High

<!-- [feature] Full agent-drivable CLI parity (init/add/update/remove) — resolved 2026-06-16 via Plan 41 (PRs #120/#122/#123/#121/#125). All mutating cmds have headless *Result cores + JSONL/exit contract (ExitConflict=5); list --json added. -->
