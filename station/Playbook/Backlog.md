...
<!-- [bug] Sensor hook commands use $PWD-walk-up — RESOLVED by v0.4.3 hotfix (2026-05-13). Absolute install-time paths now baked into hook commands. See Status.md Recently Done. (removed 2026-09-15 backlog-hygiene) -->
...
<!-- [feature] bonsai init/add need non-interactive flags — RESOLVED by v0.4.2 (2026-05-13). --non-interactive + --from-config shipped for init+add. See Status.md Recently Done. Broader CLI parity (update/remove) tracked at P1 below. (removed 2026-09-15 backlog-hygiene) -->
...
- **[ops] HOMEBREW_TAP_TOKEN PAT expiry — OVERDUE** — PAT rotated 2026-04-22, reminder target ~2026-07-15. **Today is 2026-09-15 — 2 months overdue; PAT likely already expired.** Rotate immediately before next release attempt. Symptom: GoReleaser brew step fails `401 Bad credentials`; binaries publish but Homebrew formula misses. *(added 2026-04-22, flagged overdue 2026-09-15 backlog-hygiene)*
