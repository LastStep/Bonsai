...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — resolved by v0.4.3 hotfix 2026-05-13 (PR #105/#106): sensor hook commands now bake install-time absolute paths into .claude/settings.json. Removed from P0 2026-07-06 (backlog-hygiene). -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — resolved by v0.4.2 release 2026-05-13: --non-interactive + --from-config added to init and add (JSONL stdout, exit codes 0/2/3/4). Broader CLI parity shipped via Plan 41 2026-06-16. Removed from P0 2026-07-06 (backlog-hygiene). -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity" — resolved by Plan 41 2026-06-16 (PRs #120/#122/#123/#121/#125): all four cmds (init/add/update/remove) now have *Result headless cores + JSONL/exit contract (ExitConflict=5); list --json; docs/agent-interface.md contract doc. Removed from P1 2026-07-06 (backlog-hygiene). -->
