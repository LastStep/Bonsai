...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — resolved 2026-05-13 via v0.4.3 hotfix (PRs #105/#106). Hook commands now bake install-time absolute paths. Removed 2026-08-24 backlog-hygiene routine. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — resolved 2026-05-13 via v0.4.2 release. --non-interactive + --from-config flags shipped for both commands. Removed 2026-08-24 backlog-hygiene routine. -->

## P1 — High

<!-- "[feature] Full agent-drivable CLI parity: init / update / add / remove" — resolved 2026-06-16 via Plan 41 (all 5 phases merged, PRs #120/#122/#123/#121/#125). All mutating cmds now have pure *Result headless cores + JSONL/exit contract. Removed 2026-08-24 backlog-hygiene routine. -->

- **[ops] HOMEBREW_TAP_TOKEN PAT expiry** `[URGENT — reminder date passed]` — PAT rotated 2026-04-22; 90-day expiry reminder was 2026-07-15, which has now passed (today: 2026-08-24). PAT is ~40 days overdue for rotation — likely expired. Next release will fail at brew step with `401 Bad credentials` unless rotated. Rotate `HOMEBREW_TAP_TOKEN` on `LastStep/Bonsai` before tagging a release. Also audit other PATs in repo secrets. *(added 2026-04-22, updated 2026-08-24 — reminder date overdue)*
