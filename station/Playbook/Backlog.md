...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — resolved v0.4.3 hotfix (PRs #105/#106, Status.md 2026-05-13). Hook commands now bake absolute install-time paths. Removed from P0 by backlog-hygiene 2026-07-05. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — resolved v0.4.2 (PR #102, Status.md 2026-05-13). --non-interactive + --from-config shipped for both commands. Remaining headless parity (update/remove) tracked under P1 "Full agent-drivable CLI parity" which was also resolved by Plan 41. Removed from P0 by backlog-hygiene 2026-07-05. -->

## P1 — High

<!-- "[feature] Full agent-drivable CLI parity: init / update / add / remove" — resolved Plan 41 (PRs #120-#125, Status.md 2026-06-16). All four mutating commands have headless *Result cores + JSONL/exit-code contract (ExitConflict=5). MCP server is fast-follow Plan 42. Removed from P1 by backlog-hygiene 2026-07-05. -->
