...
<!-- RESOLVED 2026-08-05 (backlog-hygiene): "[bug] Sensor hook commands use $PWD-walk-up" — shipped in v0.4.3 (Status.md Done 2026-05-13). Hook commands now bake install-time absolute paths. -->
...
<!-- RESOLVED 2026-08-05 (backlog-hygiene): "[feature] bonsai init / bonsai add need non-interactive flags [Plan 38 P2 blocker]" — shipped in v0.4.2 (Status.md Done 2026-05-13). --non-interactive + --from-config added to init and add. -->

## P1 — High

<!-- RESOLVED 2026-08-05 (backlog-hygiene): "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — shipped in Plan 41 (Status.md Done 2026-06-16). Every mutating cmd has a pure *Result headless core + JSONL/exit contract (ExitConflict=5); list --json; docs/agent-interface.md contract doc. -->
