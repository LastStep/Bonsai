...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED. v0.4.3 hotfix shipped 2026-05-13 (PRs #105/#106): hook commands now bake absolute install-time project root. Existing projects need `bonsai update`. Cleared by backlog-hygiene 2026-06-22. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — RESOLVED. v0.4.2 shipped --non-interactive + --from-config flags (PR #102, 2026-05-13). Cleared by backlog-hygiene 2026-06-22. -->
