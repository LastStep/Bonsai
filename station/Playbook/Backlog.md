...
<!-- "[bug] Sensor hook commands use $PWD-walk-up — breaks in multi-.bonsai.yaml setups" — resolved 2026-05-13 via v0.4.3 hotfix (PRs #105/#106). Hooks now bake install-time absolute paths. Existing projects need `bonsai update`. Removed from P0 2026-07-18 (backlog-hygiene). -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags [Plan 38 P2 blocker]" — resolved 2026-05-13 via v0.4.2 (PR #102). --non-interactive + --from-config shipped for both init and add. Removed from P0 2026-07-18 (backlog-hygiene). -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init/update/add/remove" — resolved 2026-06-16 via Plan 41 (PRs #120/#122/#123/#121/#125). All mutating cmds have pure *Result headless cores + JSONL/exit contract (ExitConflict=5); list --json added; docs/agent-interface.md contract doc shipped. Removed from P1 2026-07-18 (backlog-hygiene). -->
