...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — Resolved 2026-05-13 by v0.4.3 hotfix (PRs #105/#106). Sensor hook commands now bake install-time absolute paths in .claude/settings.json. (backlog-hygiene 2026-07-23) -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — Resolved 2026-05-13 by v0.4.2 release (PR #102). --non-interactive + --from-config flags shipped for init and add; JSONL stdout, exit codes 0/2/3/4. Unblocked Plan 38 P2 rung-3. (backlog-hygiene 2026-07-23) -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — Resolved 2026-06-16 by Plan 41 (PRs #120/#122/#123/#121/#125, main ab202c3). Every mutating cmd (init/add/update/remove) now has a pure *Result headless core + JSONL/exit contract (ExitConflict=5); list --json; docs/agent-interface.md contract doc. (backlog-hygiene 2026-07-23) -->
