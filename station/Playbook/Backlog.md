...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED 2026-05-13 via v0.4.3 hotfix: hook commands now bake install-time absolute paths (PRs #105/#106). Removed from Backlog 2026-07-11 backlog-hygiene. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — RESOLVED 2026-05-13 via v0.4.2 (--non-interactive + --from-config for init/add); further extended 2026-06-16 via Plan 41 (headless cores for all 4 commands). Removed from Backlog 2026-07-11 backlog-hygiene. -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — RESOLVED 2026-06-16 via Plan 41 (PRs #120/#122/#123/#121/#125): every mutating cmd has a pure *Result headless core + JSONL/exit contract (ExitConflict=5); list --json; docs/agent-interface.md contract doc. Removed from Backlog 2026-07-11 backlog-hygiene. -->
