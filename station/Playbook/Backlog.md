...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED by v0.4.3 hotfix (2026-05-13, PR #105/#106). Hooks now bake absolute install-time project root. Removed from P0 by backlog-hygiene 2026-08-26. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — RESOLVED by v0.4.2 (2026-05-13). --non-interactive + --from-config shipped. Removed from P0 by backlog-hygiene 2026-08-26. -->

_(No active P0 items — all critical issues resolved. See comments above for closed items.)_

## P1 — High

<!-- "[feature] Full agent-drivable CLI parity" — RESOLVED by Plan 41 (2026-06-16, PRs #120-#125, main ab202c3). All 4 cmds (init/add/update/remove) have headless *Result cores + JSONL/exit contract. Removed from P1 by backlog-hygiene 2026-08-26. -->
