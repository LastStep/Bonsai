...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — resolved 2026-05-13 via v0.4.3 hotfix (PRs #105/#106, commit 584b82b). Hook commands now bake install-time absolute paths into .claude/settings.json. *(added 2026-05-13, removed 2026-07-09 by backlog-hygiene routine)* -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — resolved 2026-05-13 via v0.4.2 release (Plan 39, PR #102, commit 410a5f1). --non-interactive + --from-config flags shipped for both init and add. *(added 2026-05-08, removed 2026-07-09 by backlog-hygiene routine)* -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — resolved 2026-06-16 via Plan 41 (PRs #120/#122/#123/#121/#125, commit ab202c3). All 4 mutating commands have pure *Result headless cores + JSONL/exit contract; list --json added; docs/agent-interface.md contract doc shipped. *(added 2026-06-13, removed 2026-07-09 by backlog-hygiene routine)* -->
