...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED. Shipped as v0.4.3 hotfix (Status.md Done 2026-05-13, PR #105/#106). Removed from P0 by backlog-hygiene 2026-08-25. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — RESOLVED. Shipped as v0.4.2 (Status.md Done 2026-05-13, PR #102). Superseded by P1 full-CLI-parity item. Removed from P0 by backlog-hygiene 2026-08-25. -->

> P0 is currently empty. See P1 for next-up work.

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — RESOLVED. Plan 41 shipped headless *Result cores + JSONL/exit-code contract for all four commands (PRs #120/#122/#123/#121/#125, main ab202c3, 2026-06-16). Removed from P1 by status-hygiene 2026-08-25. -->
