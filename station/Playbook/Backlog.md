...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED via v0.4.3 hotfix (PR #105/#106, 2026-05-13). Status.md confirms shipped. Removed by backlog-hygiene 2026-06-17. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — RESOLVED via v0.4.2 (2026-05-13). --non-interactive + --from-config shipped. Superseded by P1 "Full agent-drivable CLI parity" item. Removed by backlog-hygiene 2026-06-17. -->

_(no active P0 items — all resolved)_

## P1 — High

<!-- "[feature] Full agent-drivable CLI parity: init/update/add/remove" — RESOLVED via Plan 41 (PRs #120/#122/#123/#121/#125, 2026-06-16). All four cmds now have pure *Result headless cores + JSONL/exit contract. MCP server = fast-follow Plan 42. Removed by backlog-hygiene 2026-06-17. -->
