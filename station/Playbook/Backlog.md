...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — resolved 2026-05-13 via v0.4.3 hotfix (PRs #105/#106). Absolute paths now baked at install time. Removed from P0 2026-06-23 (backlog-hygiene). -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — resolved 2026-05-13 via v0.4.2 release (PR #102). --non-interactive + --from-config shipped. Removed from P0 2026-06-23 (backlog-hygiene). -->

_(No active P0 items.)_

## P1 — High

<!-- "[feature] Full agent-drivable CLI parity: init / update / add / remove" — resolved 2026-06-16 via Plan 41 (PRs #120/#122/#123/#121/#125). All 4 mutating cmds have pure *Result headless cores + JSONL/exit contract. Removed from P1 2026-06-23 (backlog-hygiene). -->
