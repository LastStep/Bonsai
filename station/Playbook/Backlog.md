...
<!-- [bug] Sensor hook commands use $PWD-walk-up — RESOLVED: v0.4.3 hotfix shipped 2026-05-13 (PR #105/#106, commit 584b82b). Absolute install-time paths now baked into hook commands by generator. Removed from backlog 2026-07-21 (backlog-hygiene). -->
...
<!-- [feature] `bonsai init` / `bonsai add` need non-interactive flags [Plan 38 P2 blocker] — RESOLVED: v0.4.2 shipped --non-interactive --from-config for init+add (2026-05-13, Plan 39). Removed from backlog 2026-07-21 (backlog-hygiene). -->

## P1 — High

<!-- [feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove — RESOLVED: Plan 41 shipped all 5 phases 2026-06-16 (PRs #120/#122/#123/#121/#125). All four cmds have headless *Result cores + JSONL/exit contract (ExitConflict=5); list --json added; docs/agent-interface.md contract doc. Removed from backlog 2026-07-21 (backlog-hygiene). -->
