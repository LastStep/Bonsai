...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — resolved 2026-07-28 via v0.4.3 (PR #105/#106): hook commands now bake install-time absolute paths. Removed from backlog by backlog-hygiene routine. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — resolved 2026-07-28 via v0.4.2 (PR #102): --non-interactive + --from-config flags shipped for init and add. Removed from backlog by backlog-hygiene routine. -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity" — resolved 2026-07-28 via Plan 41 (PR #120/#122/#123/#121/#125, main ab202c3): headless *Result cores + JSONL/exit-code contract shipped for all four commands (init/add/update/remove) + list --json. Follow-ups (MCP server Plan 42, unify remove logic, website vuln) already in Backlog P2. Removed from backlog by backlog-hygiene routine. -->
