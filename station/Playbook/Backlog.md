...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED: shipped as v0.4.3 (PRs #105/#106, 2026-05-13). Bonsai now bakes absolute install-time paths into hook commands. Removed by backlog-hygiene 2026-07-29. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" [Plan 38 P2 blocker] — RESOLVED: shipped as v0.4.2 (PR #102, 2026-05-13). --non-interactive + --from-config added to both commands with JSONL stdout and exit codes 0/2/3/4. Removed by backlog-hygiene 2026-07-29. -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — RESOLVED: shipped as Plan 41 / Headless CLI Contract (PRs #120/#122/#123/#121/#125, 2026-06-16). All four commands have pure *Result headless cores + JSONL/exit contract (ExitConflict=5); list --json added; docs/agent-interface.md contract doc. Removed by backlog-hygiene 2026-07-29. -->
