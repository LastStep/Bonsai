...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — resolved via v0.4.3 (PRs #105/#106, 2026-05-13). Sensor hooks now bake install-time absolute project root. Removed from backlog 2026-07-26 (backlog-hygiene). -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — resolved via v0.4.2 (Plan 39, PR #102, 2026-05-13). --non-interactive + --from-config shipped for init + add. Removed from backlog 2026-07-26 (backlog-hygiene). -->

_(No active P0 items.)_

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — resolved via Plan 41 (PRs #120/#122/#123/#121/#125, 2026-06-16). All 4 mutating cmds (init/add/update/remove) have headless *Result cores + JSONL/exit contract. Removed from backlog 2026-07-26 (backlog-hygiene). -->
