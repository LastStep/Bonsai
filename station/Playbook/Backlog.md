...
<!-- [bug] Sensor hook commands `$PWD`-walk-up — RESOLVED by v0.4.3 hotfix (2026-05-13, PRs #105/#106). Hook commands now bake install-time absolute project root into `.claude/settings.json`. Removed by backlog-hygiene 2026-08-09. -->
...
<!-- [feature] `bonsai init` / `bonsai add` non-interactive flags — RESOLVED by v0.4.2 (2026-05-13). `--non-interactive --from-config <path>` shipped for init+add. Unblocked Plan 38 P2 rung-3. Removed by backlog-hygiene 2026-08-09. -->

## P1 — High

<!-- [feature] Full agent-drivable CLI parity: init / update / add / remove — RESOLVED by Plan 41 (2026-06-16, PRs #120/#122/#123/#121/#125). All four cmds have `*Result` headless cores + JSONL/exit contract (`ExitConflict=5`). Removed by backlog-hygiene 2026-08-09. -->
