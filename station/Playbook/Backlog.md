...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — resolved by v0.4.3 hotfix (PRs #105/#106, commit 584b82b). Absolute install-time paths now baked into hook commands. Cleared by backlog-hygiene 2026-09-19. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — resolved by v0.4.2 (PR #102) + Plan 41 full headless CLI contract. Cleared by backlog-hygiene 2026-09-19. -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — resolved by Plan 41 (PRs #120/#122/#123/#121/#125, main ab202c3). All four commands now have pure *Result headless cores + JSONL/exit contract. Cleared by backlog-hygiene 2026-09-19. -->
