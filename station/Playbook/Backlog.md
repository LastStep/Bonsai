...
<!-- [bug] Sensor hook commands $PWD-walk-up — RESOLVED in v0.4.3 (2026-05-13). Hook commands now bake install-time absolute project root into each entry in .claude/settings.json. removed 2026-07-01 (backlog-hygiene routine). -->
...
<!-- [feature] bonsai init/add non-interactive flags — RESOLVED in v0.4.2 (2026-05-13). --non-interactive + --from-config shipped for both init and add. removed 2026-07-01 (backlog-hygiene routine). -->

## P1 — High

<!-- [feature] Full agent-drivable CLI parity: init / update / add / remove — RESOLVED in Plan 41 (2026-06-16). All four cmds have headless *Result cores + JSONL/exit contract (ExitConflict=5); list --json; agent-interface.md doc. PRs #120/#122/#123/#121/#125. removed 2026-07-01 (backlog-hygiene routine). -->
