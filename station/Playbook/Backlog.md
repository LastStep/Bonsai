...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED v0.4.3 (2026-05-13). Hooks now bake absolute install-time paths. Existing projects need `bonsai update`. Removed from P0 by backlog-hygiene 2026-08-27. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — RESOLVED v0.4.2 (2026-05-13). --non-interactive + --from-config shipped. Superseded by P1 full-parity item (Plan 41). Removed from P0 by backlog-hygiene 2026-08-27. -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — RESOLVED Plan 41 (2026-06-16). All 5 phases merged; every mutating cmd has a pure *Result headless core + JSONL/exit contract (ExitConflict=5); list --json; docs/agent-interface.md contract doc. Removed from P1 by backlog-hygiene 2026-08-27. -->
