...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED v0.4.3 (PR #105/#106, 2026-05-13). Absolute install-time paths now baked into .claude/settings.json hook commands. Removed from Backlog by backlog-hygiene routine 2026-08-21. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — RESOLVED v0.4.2 (PR #102, 2026-05-13). --non-interactive + --from-config flags shipped for init and add. Removed from Backlog by backlog-hygiene routine 2026-08-21. -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — RESOLVED by Plan 41 (PRs #120/#122/#123/#121/#125, 2026-06-16). All four mutating commands now have pure *Result headless cores + JSONL/exit contract (ExitConflict=5); list --json; docs/agent-interface.md shipped. Removed from Backlog by backlog-hygiene routine 2026-08-21. -->
