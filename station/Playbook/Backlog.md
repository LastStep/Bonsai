...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — resolved via v0.4.3 hotfix (bake absolute install-time path; PRs #105/#106, shipped 2026-05-13). Removed backlog-hygiene 2026-09-23. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags [Plan 38 P2 blocker]" — resolved via v0.4.2 (--non-interactive + --from-config flags, JSONL stdout, exit codes 0/2/3/4; PR #102, shipped 2026-05-13). Removed backlog-hygiene 2026-09-23. -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — resolved via Plan 41 (all four mutating cmds have pure *Result headless cores + JSONL/exit contract ExitConflict=5; list --json; docs/agent-interface.md; PRs #120-#125, shipped 2026-06-16). Removed backlog-hygiene 2026-09-23. -->
