...
<!-- Resolved 2026-05-13 by v0.4.3 hotfix — sensor hook commands now bake install-time absolute paths into `.claude/settings.json` (vs `$PWD`-walk-up). PRs #105/#106. Existing projects need `bonsai update`. (backlog-hygiene 2026-08-10) -->
...
<!-- Resolved 2026-05-13 by v0.4.2 release — `--non-interactive` + `--from-config` added to `bonsai init` and `bonsai add`. JSONL stdout + exit codes 0/2/3/4. PR #102. (backlog-hygiene 2026-08-10) -->

## P1 — High

<!-- Resolved 2026-06-16 by Plan 41 — all 4 mutating cmds (init/add/update/remove) ship pure *Result headless cores + JSONL/exit contract (ExitConflict=5). `list --json` added. `docs/agent-interface.md` contract doc shipped. PRs #120–#125. (backlog-hygiene 2026-08-10) -->
