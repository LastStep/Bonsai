...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — resolved 2026-05-13 via v0.4.3 hotfix (PRs #105/#106). Hook commands now bake install-time absolute paths. -->
