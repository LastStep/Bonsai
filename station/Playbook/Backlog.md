...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED v0.4.3 (2026-05-13, PR #105/#106). Hook commands now bake absolute install-time project root. Removed from backlog 2026-07-15 (backlog-hygiene). -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — RESOLVED v0.4.2 (2026-05-13); full headless parity for all four commands shipped Plan 41 (2026-06-16). Removed from backlog 2026-07-15 (backlog-hygiene). -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — RESOLVED Plan 41 (2026-06-16, PRs #120/#122/#123/#121/#125). All four mutating cmds have pure *Result headless cores + JSONL/exit contract. Removed from backlog 2026-07-15 (backlog-hygiene). -->
