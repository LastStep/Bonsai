...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED: shipped in v0.4.3 (PRs #105/#106, 2026-05-13). Hook commands now bake install-time absolute paths. Removed from P0 by backlog-hygiene 2026-07-25. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — RESOLVED: shipped in v0.4.2 (PR #102, 2026-05-13). --non-interactive + --from-config added to init and add. Removed from P0 by backlog-hygiene 2026-07-25. -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — RESOLVED: shipped via Plan 41 (PRs #120/#122/#123/#121/#125, 2026-06-16). All four commands have headless cores + JSONL/exit contract. Removed from P1 by backlog-hygiene 2026-07-25. -->

- **[security] Dependency CVEs: golang.org/x/text GO-2026-5970 + goldmark GO-2026-5320** — govulncheck on PR #180 (2026-07-25) found 2 reachable vulns in current main: (1) GO-2026-5970 — infinite loop on invalid input in `golang.org/x/text@v0.36.0`, fixed in `v0.39.0`, reachable via `cmd/bonsai/main.go`; (2) GO-2026-5320 — XSS in `github.com/yuin/goldmark@v1.7.13`, fixed in `v1.7.17`, reachable via glamour in `internal/tui/guideflow/render.go`. Fix: `go get golang.org/x/text@v0.39.0 && go get github.com/yuin/goldmark@v1.7.17 && go mod tidy`. govulncheck CI is red on every PR until resolved. *(added 2026-07-25, source: bonsai-loop CI govulncheck)*
