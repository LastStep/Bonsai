...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — resolved v0.4.3 (PR #105/#106, 2026-05-13). Removed by backlog-hygiene 2026-09-06. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — resolved v0.4.2 (Plan 39, PR #102, 2026-05-13). Removed by backlog-hygiene 2026-09-06. -->

_(no active P0 items — escalate any new critical blockers here immediately)_

## P1 — High

<!-- [feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove — resolved by Plan 41 (all 5 phases merged 2026-06-16, headless *Result cores + JSONL/exit contract for init/add/update/remove + list --json + docs/agent-interface.md). Removed by status-hygiene 2026-09-06. -->
