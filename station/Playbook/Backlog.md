...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — fixed in v0.4.3 (PR #105/#106, 2026-05-13). Existing projects need `bonsai update` to refresh. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — fixed in v0.4.2 (PR #102, 2026-05-13). --non-interactive + --from-config shipped for init and add. -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity" — resolved by Plan 41 (all 5 phases merged 2026-06-16). All four commands (init/add/update/remove) now have headless *Result cores + JSONL/exit-code contract. Removed from P1 backlog 2026-09-08 status-hygiene routine. -->
