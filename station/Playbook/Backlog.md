...
<!-- RESOLVED 2026-05-13 (v0.4.3 hotfix, PR #105/#106): "[bug] Sensor hook commands use $PWD-walk-up — breaks in multi-.bonsai.yaml setups" [Plan 39 follow-up] — hook commands now bake install-time absolute paths; existing projects need `bonsai update`. Status.md Recently Done confirms ship. -->
...
<!-- RESOLVED 2026-05-13 (v0.4.2, PR #102): "[feature] bonsai init / bonsai add need non-interactive flags" [Plan 38 P2 blocker] — --non-interactive + --from-config shipped for both commands with JSONL stdout and exit codes 0/2/3/4. Status.md Recently Done confirms ship. -->

## P1 — High

<!-- RESOLVED 2026-06-16 (Plan 41, PRs #120/#122/#123/#121/#125, main ab202c3): "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — every mutating cmd now has a pure *Result headless core + JSONL/exit contract (ExitConflict=5); list --json; docs/agent-interface.md contract doc. Status.md Recently Done confirms ship. -->
