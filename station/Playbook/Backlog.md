...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED: v0.4.3 hotfix shipped 2026-05-13 (Status.md). Hook commands now bake absolute install-time project root. Removed by backlog-hygiene 2026-06-20. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — RESOLVED: --non-interactive + --from-config shipped in v0.4.2 (2026-05-13). Removed by backlog-hygiene 2026-06-20. -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — RESOLVED: Plan 41 shipped headless `*Result` cores + JSONL/exit contract for all 4 mutating commands (init/add/update/remove) + `list --json` in PRs #120/#122/#123/#121/#125 (2026-06-16). Removed by status-hygiene 2026-06-20. -->
