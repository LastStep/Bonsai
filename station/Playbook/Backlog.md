...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED 2026-05-13 via v0.4.3 hotfix (PRs #105/#106, Status.md Recently Done). Baked absolute install-time paths into hook commands. Users on older installs need `bonsai update`. (removed by backlog-hygiene 2026-08-22) -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — RESOLVED 2026-05-13 via v0.4.2 release (PR #102, Status.md Recently Done). --non-interactive + --from-config <path> flags added. Unblocked Plan 38 P2 rung-3. (removed by backlog-hygiene 2026-08-22) -->
