...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — resolved in v0.4.3 (PRs #105/#106, commit 584b82b, 2026-05-13). Hook commands now bake install-time absolute paths. Existing projects need `bonsai update`. Removed by backlog-hygiene 2026-07-13. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" [Plan 38 P2 blocker] — resolved in v0.4.2 (PR #102, commit 410a5f1, 2026-05-13). --non-interactive + --from-config shipped for both commands. Removed by backlog-hygiene 2026-07-13. -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — resolved by Plan 41 (PRs #120/#122/#123/#121/#125, main ab202c3, 2026-06-16). All four mutating cmds have pure *Result headless cores + JSONL/exit contract (ExitConflict=5); list --json; docs/agent-interface.md contract doc. Removed by backlog-hygiene 2026-07-13. -->
