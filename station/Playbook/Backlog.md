...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED by v0.4.3 hotfix (2026-05-13, PR #105/#106). Absolute install-time project root now baked into hook commands. Removed from P0 by backlog-hygiene 2026-07-04. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — RESOLVED by v0.4.2 (2026-05-13, PR #102). --non-interactive + --from-config flags shipped. Removed from P0 by backlog-hygiene 2026-07-04. -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — RESOLVED by Plan 41 (2026-06-16, PRs #120/#122/#123/#121/#125). Every mutating cmd has headless *Result core + JSONL/exit contract; `list --json` added; agent-interface.md contract doc shipped. Removed from P1 by backlog-hygiene 2026-07-04. -->
