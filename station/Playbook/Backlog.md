...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — resolved via v0.4.3 (PR #105/#106, 2026-05-13). Absolute install-time paths now baked in. Existing projects need `bonsai update` to refresh. Removed from P0 2026-06-27 (backlog-hygiene). -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — resolved via v0.4.2 (PR #102, 2026-05-13). --non-interactive + --from-config shipped for init and add. Superseded by P1 "Full agent-drivable CLI parity" item. Removed from P0 2026-06-27 (backlog-hygiene). -->
