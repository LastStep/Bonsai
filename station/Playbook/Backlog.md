...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — resolved via v0.4.3 hotfix (2026-05-13, PRs #105/#106). Absolute install-time project root now baked into each hook command. Removed from Backlog by backlog-hygiene routine 2026-08-03. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — resolved via v0.4.2 (2026-05-13, PR #102). --non-interactive + --from-config added to init and add; unblocked Plan 38 P2 rung-3. Removed from Backlog by backlog-hygiene routine 2026-08-03. -->

## P1 — High

<!-- "[feature] Full agent-drivable CLI parity: init / update / add / remove" — resolved via Plan 41 (2026-06-16, PRs #120/#122/#123/#121/#125). All 4 mutating commands have headless *Result cores + JSONL/exit contract (ExitConflict=5); list --json; agent-interface.md contract doc. Removed from Backlog by backlog-hygiene routine 2026-08-03. -->
