...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — resolved 2026-05-13: v0.4.3 hotfix baked absolute install-time paths into hook commands (PRs #105/#106, commit 584b82b). Existing projects need `bonsai update` to refresh. -->
...
<!-- "[feature] bonsai init/add need non-interactive flags" — resolved 2026-05-13: v0.4.2 shipped --non-interactive + --from-config for init and add (PR #102, commit 410a5f1). -->

_(no active P0 items)_

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — resolved 2026-06-16: Plan 41 shipped all 5 phases (PRs #120/#122/#123/#121/#125, main ab202c3). Every mutating cmd has pure *Result headless core + JSONL/exit contract (ExitConflict=5); list --json; docs/agent-interface.md contract doc. MCP server = Plan 42 fast-follow. -->
