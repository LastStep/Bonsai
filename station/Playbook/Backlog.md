...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — resolved by v0.4.3 hotfix 2026-05-13 (Status.md Recently Done); sensor hook commands now bake install-time absolute paths. Removed from backlog by backlog-hygiene routine 2026-09-10. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — resolved by v0.4.2 release 2026-05-13 (Status.md Recently Done); --non-interactive + --from-config flags shipped for init and add. Superseded further by Plan 41 (full headless parity). Removed from backlog by backlog-hygiene routine 2026-09-10. -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — resolved by Plan 41 2026-06-16 (Status.md Recently Done); all 4 mutating commands now have pure *Result headless cores + JSONL/exit contract (ExitConflict=5) + list --json + docs/agent-interface.md. Removed from backlog by backlog-hygiene routine 2026-09-10. -->
