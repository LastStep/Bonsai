...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED via v0.4.3 hotfix (PR #105/#106, 2026-05-13). Absolute install-time paths now baked into hook commands. Existing projects need `bonsai update`. Removed from P0 2026-06-14 (backlog-hygiene). -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — RESOLVED via v0.4.2 (PR #102, 2026-05-13). --non-interactive + --from-config shipped for both init and add. Removed from P0 2026-06-14 (backlog-hygiene). -->
