...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — resolved v0.4.3 hotfix (PR #105/#106, 2026-05-13): hook commands now bake install-time absolute paths. Existing projects need `bonsai update`. Removed 2026-09-22 (backlog-hygiene). -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — resolved v0.4.2 release (Plan 39, PR #102, 2026-05-13): --non-interactive + --from-config shipped for init and add. Removed 2026-09-22 (backlog-hygiene). -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — resolved Plan 41 (PRs #120/#122/#123/#121/#125, 2026-06-16): all 4 mutating cmds have pure *Result headless cores + JSONL/exit contract. Removed 2026-09-22 (backlog-hygiene). -->
