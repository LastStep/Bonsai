...
<!-- "[bug] Sensor hook commands use `$PWD`-walk-up" — RESOLVED: fixed in v0.4.3 (2026-05-13, PRs #105/#106). Hook commands now bake absolute install-time paths. `bonsai update` refreshes existing projects. (removed 2026-08-23, backlog-hygiene routine) -->
...
<!-- "[feature] `bonsai init` / `bonsai add` need non-interactive flags" — RESOLVED: shipped in v0.4.2 (2026-05-13, PR #102). Superseded by P1 "Full agent-drivable CLI parity" item. (removed 2026-08-23, backlog-hygiene routine) -->
