...
<!-- "[bug] Sensor hook commands use $PWD-walk-up" — RESOLVED 2026-05-13 via v0.4.3 (PR #105/#106). Absolute install-time paths now baked into hook commands. Removed from P0 by backlog-hygiene 2026-06-28. -->
...
<!-- "[feature] bonsai init / bonsai add need non-interactive flags" — RESOLVED 2026-05-13 via v0.4.2 (PR #102). --non-interactive + --from-config shipped. Removed from P0 by backlog-hygiene 2026-06-28. -->

## P1 — High

<!-- "[feature] Full agent-drivable (non-interactive) CLI parity: init / update / add / remove" — RESOLVED 2026-06-16 via Plan 41 (PRs #120/#122/#123/#121/#125, main ab202c3). All 4 mutating cmds have pure *Result headless cores + JSONL/exit contract. Removed from P1 by status-hygiene 2026-06-28. -->

- **[ops] HOMEBREW_TAP_TOKEN PAT expiry calendar reminder** `[TIME-SENSITIVE: due ~2026-07-15]` — Fine-grained PATs default to 90-day expiry. The `HOMEBREW_TAP_TOKEN` secret on `LastStep/Bonsai` was rotated 2026-04-22 — **rotate by ~2026-07-15 (17 days from 2026-06-28)**. Same applies to any other PATs in repo secrets. Symptom of expired PAT: GoReleaser fails at brew step with `GET https://api.github.com/repos/LastStep/homebrew-tap: 401 Bad credentials` — release otherwise succeeds (binaries published, only formula update missed). *(added 2026-04-22, flagged urgent 2026-06-28 backlog-hygiene, source: v0.2.0 release session)*
