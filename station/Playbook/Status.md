...
|------|------|-------|-------|
| `bonsai init` cinematic redesign — 5 phases / 5 PRs, behind `BONSAI_REDESIGN=1` until Phase 5 flips default | 22 | general-purpose | Phases 1–4 shipped (PRs #47, #48, #49, #50) + 6 direct-to-main dogfood polish passes 2026-04-21 (`380dbc5`, `413e360`, `399fe08`, `eaee416`, `6bb74e5`, `fa0ae64`). Next: Phase 5 (Observe + Generate + Planted, flip default, delete legacy). |
