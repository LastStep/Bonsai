...
|------|------|-------|-------|
| `bonsai init` cinematic redesign — 5 phases / 5 PRs, behind `BONSAI_REDESIGN=1` until Phase 5 flips default | 22 | general-purpose | Phases 1–2 shipped (PRs #47, #48). Next: Phase 3 (Vessel + Soil stages — real input). |
