...
| Release prep — Go toolchain + triggerSection + OSS polish | 17 | general-purpose | Executed + reviewed (PASS). Draft [PR #24](https://github.com/LastStep/Bonsai/pull/24) targeting `release-prep` (NOT main). Awaiting CI + merge to `release-prep`. |
