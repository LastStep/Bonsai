...
| Adversarial review of a drafted plan via 6 critic agents before dispatch; running a "grill the plan" review pass on a Tier-2 plan. | [agent/Workflows/plan-grilling.md](agent/Workflows/plan-grilling.md) |
...
| Prompt templates for the 6 plan-grilling critic agents; dispatched verbatim by plan-grilling.md — one parallel Agent call per critic. | [agent/Skills/critic-agent-prompts.md](agent/Skills/critic-agent-prompts.md) |
