...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — `Research/` directory no longer exists in repo; files not found as of 2026-06-24 memory-consolidation sweep. Flag for user: locate or confirm deleted.)
