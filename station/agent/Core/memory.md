...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — `station/Research/` directory not found as of 2026-08-06 memory-consolidation; files may have been moved or never committed. Verify with user before referencing.)
