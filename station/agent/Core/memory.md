...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — `Research/` directory not present in repo as of 2026-08-18; files may have been removed or never committed. Verify with user before relying on these.)
