...
- **Foundational research docs** — (stale — `station/Research/` directory removed; files no longer exist as of 2026-09-11 memory-consolidation check. Re-add if Research/ is recreated.)
