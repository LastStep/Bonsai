...
- **Foundational research docs** — Anchor for methodology/concept decisions. *(stale — station/Research/ directory not found on disk or in git history; files last confirmed present 2026-05-07, now missing — may have been untracked-only and deleted. Flagged 2026-07-01 memory-consolidation.)*
