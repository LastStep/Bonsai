...
- **Foundational research docs** — Anchor for methodology/concept decisions. **(stale — station/Research/ never committed to git; files presumed on user's local machine only. Verify before referencing.)**
