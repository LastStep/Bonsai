...
- [FLAG] Archive Plan 41 — `Plans/Active/41-headless-cli-contract.md` → `Plans/Archive/`. Shipped 2026-06-16; noted in Work State for 24+ days without action; escalated by memory-consolidation 2026-07-10 (3+ sessions unactioned). Action at next wrap-up session.
...
- **Foundational research docs** — Anchor for methodology/concept decisions. **(stale — `station/Research/` directory not found on current machine; files appear local-only on prior machine `/home/rohan/ZenGarden/Bonsai/`; flagged by memory-consolidation 2026-07-10)**
