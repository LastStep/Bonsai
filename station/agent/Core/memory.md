...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — `station/Research/` directory and all RESEARCH-*.md files not found in repo or git history as of 2026-07-21; files may have been local-only and never committed. Last validated present: 2026-05-07. Flagged for user: confirm if files exist elsewhere or remove this block.)
