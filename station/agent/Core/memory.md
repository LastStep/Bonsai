...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — `Research/` directory never existed in git history; all 6 paths below resolve to missing files as of 2026-07-22 memory-consolidation audit. Flag for user: either create the directory with these docs or remove these entries.)
