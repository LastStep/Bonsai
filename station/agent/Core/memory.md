...
- Plan 15 (BubbleTea foundation) — on `ui-ux-testing` branch, ~17 commits ahead of main. All five iters shipped locally. Latest: `4b35971` iter-3.2 OtherAgents sort, `b4cb17f` iter-3.1 doc reconcile, `39d9da3` iter-3.1 add.go index fix, `a406908` iter-3 full migration. Safety branches: `ui-ux-testing-pre-rebase` (`2fa91d0`) + `ui-ux-testing-pre-iter2-rebase` (`2d7a947`) — keep ~30d.
**Blocked on:** Nothing.
