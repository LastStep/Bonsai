...
- **Foundational research docs** (stale — `station/Research/` directory never committed to git; files do not exist in repo as of 2026-07-12 memory-consolidation check) — Anchor for methodology/concept decisions.
