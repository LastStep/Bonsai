...
- **Foundational research docs** — (stale — `station/Research/` directory does not exist in repo; files were never committed to git. Paths below are aspirational references only. If Research files are added, update paths accordingly.)
