...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — `Research/` directory not found at repo root as of 2026-08-22 memory-consolidation routine; files may have been removed or never committed. Verify before relying on these paths.)
