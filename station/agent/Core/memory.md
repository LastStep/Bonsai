...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — `Research/` directory does not exist in this repo; files never committed to git. Were likely local-only on original dev machine at `/home/rohan/ZenGarden/Bonsai/Research/`. Flagged 2026-06-26 memory-consolidation routine. User should confirm: were these files lost, or are they in a private location?)
    - `Research/RESEARCH-landscape-analysis.md` — Bonsai vs GSD/ECC/others; identity/coordination layer positioning (stale — file not found)
    - `Research/RESEARCH-concept-decisions.md` — Ambient vs command-driven, authority hierarchy, catalog ownership, talents taxonomy (stale — file not found)
    - `Research/RESEARCH-eval-system.md` — Eval system concept: scenarios, evaluators, benchmarks (stale — file not found)
    - `Research/RESEARCH-trigger-system.md` — Trigger section design research (stale — file not found)
    - `Research/RESEARCH-uiux-overhaul.md` — UI/UX overhaul research (stale — file not found)
    - `Research/RESEARCH-proof-of-bonsai-effectiveness.md` — OSS launch proof-of-work pre-registration (cut-over `4dfd3f4` 2026-04-14). Pick up when ready — user answers §10 first. (stale — file not found)
