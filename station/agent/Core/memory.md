...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — `Research/` directory no longer exists on filesystem; files confirmed missing 2026-07-06 memory consolidation. User action needed: locate or re-create Research/ docs, or remove these entries.)
