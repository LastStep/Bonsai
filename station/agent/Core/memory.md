...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — Research/ directory not found at project root or station/; all 6 files missing as of 2026-07-18 memory-consolidation routine. Flagged for user: confirm if Research/ was deleted, moved, or never committed.)
