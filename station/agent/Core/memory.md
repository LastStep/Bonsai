...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — `Bonsai/Research/` directory not found in workspace; files may never have been committed or were removed)
