...
- **Foundational research docs** — Anchor for methodology/concept decisions. **(stale — 2026-06-14 memory-consolidation: `station/Research/` directory no longer exists; all 6 RESEARCH-*.md files missing from repo. Files may have been moved or removed. Flagged for user — locate or remove these entries.)**
