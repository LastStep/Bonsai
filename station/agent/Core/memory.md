...
- **Foundational research docs** — (stale — `station/Research/` directory does not exist as of 2026-08-24 validation; files were removed or never committed. Archive these refs if research content is gone permanently.)
    ...
    - `Research/RESEARCH-proof-of-bonsai-effectiveness.md` (stale — file not found) — OSS launch proof-of-work pre-registration (cut-over `4dfd3f4` 2026-04-14)
