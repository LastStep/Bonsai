...
- **Foundational research docs** — Anchor for methodology/concept decisions. *(stale — 2026-09-13: `station/Research/` directory not found; all six files below are unreachable. Verify whether files were moved or deleted before referencing.)*
