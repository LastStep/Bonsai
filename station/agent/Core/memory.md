...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — station/Research/ directory not found on disk or in git as of 2026-07-29; files may have lived only in a prior local environment)
