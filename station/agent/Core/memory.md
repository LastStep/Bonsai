...
- **Foundational research docs** — Anchor for methodology/concept decisions. *(stale — `station/Research/` directory does not exist; all 6 files missing as of 2026-08-02 memory-consolidation audit. Flag for user: locate or remove these references.)*
