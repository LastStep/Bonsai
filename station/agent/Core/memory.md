...
- **Foundational research docs** — Anchor for methodology/concept decisions. *(stale — `station/Research/` directory does not exist; all six files below are missing as of 2026-09-14 memory-consolidation routine. Verify with user whether files were moved, deleted, or never committed.)*
