...
- **Foundational research docs** — Anchor for methodology/concept decisions. *(stale — `Research/` directory not found in repo as of 2026-09-06; files may have been deleted or never committed. Verify with user before using these links.)*
