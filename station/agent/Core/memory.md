...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — `station/Research/` directory not found on current system as of 2026-07-13; all 6 files below return 404. Likely not migrated to current environment. Restore if docs still exist.)
