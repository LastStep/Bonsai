...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — `station/Research/` directory not found 2026-07-28; flagged by doc-freshness-check. User action required to locate or restore these files.)
