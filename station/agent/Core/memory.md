...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — `Research/` directory deleted; files absent as of 2026-07-27 memory-consolidation check. Flagged for user: confirm deletion was intentional or restore from git history.)
