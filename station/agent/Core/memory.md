...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — `station/Research/` directory not found in repo as of 2026-07-24 memory-consolidation; files may have been local-only and never committed. Retain as conceptual anchors until confirmed deleted or relocated.)
