...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — `station/Research/` directory no longer exists; all 6 paths below are broken as of 2026-07-09 validation. User should confirm if docs were deleted or moved before removing this block.)
