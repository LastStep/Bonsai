...
- **Foundational research docs** — (stale — `Research/` directory does not exist on disk and has no git history; files were never committed. Validated 2026-08-07 by memory-consolidation routine.) If these documents exist, re-add their paths here when located.
