...
- **Foundational research docs** — (stale — files not present in current environment; existed at `/home/rohan/ZenGarden/Bonsai/station/Research/` on prior machine, never committed to git. Re-create or locate before referencing. Marked stale 2026-08-13.)
