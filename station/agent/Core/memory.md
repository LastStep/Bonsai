...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — `Research/` directory not found in Bonsai project root as of 2026-08-09 memory-consolidation audit; files may have been moved or never committed)
