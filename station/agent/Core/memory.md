...
- **Foundational research docs** — Anchor for methodology/concept decisions. *(stale — `station/Research/` directory does not exist as of 2026-06-30 memory-consolidation audit; all 6 paths below are unresolvable. Files may have been moved or deleted. Flag for user: locate or remove.)*
