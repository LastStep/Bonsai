...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — `station/Research/` directory does not exist as of 2026-06-25 memory-consolidation audit; files may have been deleted or never committed to this repo. Flag for user: confirm intended location or remove these pointers.)
