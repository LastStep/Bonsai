...
- **Foundational research docs** — Anchor for methodology/concept decisions. ⚠️ **[STALE 2026-08-05] `station/Research/` directory not found — all 6 paths below are broken.** Verified by memory-consolidation routine (find returned no results). Research docs may have been deleted or moved. Confirm with user before relying on these links.
