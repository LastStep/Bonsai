...
**Current task:** Plan 40 Phases 1–3 **SHIPPED on main** (v0.5.0 additive, **untagged** — PRs #114/#116/#115; review caught+fixed a blocking out-of-tree-read sec-bug). Phase 4 HELD, dogfood deferred (no update-delivery path until P4 + repo gitignores `.bonsai-lock.yaml` → validate can't pass here), **tag held** (user 2026-06-13). **Next main thing:** full agent-drivable non-interactive CLI parity init/update/add/remove — [Backlog P1](../../Playbook/Backlog.md), `/plan` next session (supersedes Plan 40 Phase 4 + Rung-2.5; unblocks the dogfood). [plan 40](../../Playbook/Plans/Active/40-odysseus-platform-integration.md). Grilling pipeline live: [workflow](../Workflows/plan-grilling.md) + `/plan` `/grill`.
