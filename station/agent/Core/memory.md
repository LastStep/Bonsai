...
- **Foundational research docs** — Anchor for methodology/concept decisions. *(stale — `station/Research/` is gitignored and absent in cloud/CI runs; all 6 files unresolvable from this environment — verify files exist locally before following links)*
