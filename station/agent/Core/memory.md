...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — `station/Research/` directory does not exist as of 2026-06-20 consolidation check; files were present in prior sessions but are not in the repo. Restore or remove when Research dir is re-created.)
