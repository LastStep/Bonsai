...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — `station/Research/` directory does not exist; all 6 files missing as of 2026-07-31 audit. User to restore or remove this block.)
