...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — files not found on disk as of 2026-09-07; paths `station/Research/RESEARCH-*.md` return no results; may have been removed or never committed.)
