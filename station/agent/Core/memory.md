...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — `station/Research/` directory does not exist on disk or in git; files not recoverable from filesystem. Flagged by doc-freshness 2026-05-02 and confirmed by memory-consolidation 2026-05-02. User decision needed: recover files or remove these links. See `Reports/Pending/2026-05-02-doc-freshness-check.md` Finding 4.)
