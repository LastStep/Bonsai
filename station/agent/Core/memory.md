...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — `station/Research/` directory does not exist; files were added 2026-04-20 with "corrected paths" but directory was never created or has since been removed. User should confirm whether these docs were relocated or deleted before next run.)
