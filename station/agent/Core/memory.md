...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — `station/Research/` directory not found on disk as of 2026-05-13; gitignored via `.gitignore`. Files may have been deleted locally. User should restore or archive this Reference entry.)
