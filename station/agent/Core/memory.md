...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — station/Research/ directory does not exist; files not found anywhere in repo as of 2026-08-31 memory-consolidation audit. User should confirm whether these were removed or never committed.)
