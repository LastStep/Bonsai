...
- **Foundational research docs** — Anchor for methodology/concept decisions. *(stale — Research/ directory does not exist in station/; files were never committed to git. Previously validated as existing on 2026-05-07, suggesting they were local-only files in a prior environment. User should locate and commit, or remove these entries.)*
