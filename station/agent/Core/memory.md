...
- **Foundational research docs** — Anchor for methodology/concept decisions. _(stale — `station/Research/` directory not found as of 2026-08-10; files may have been removed or never committed. User should confirm location or remove these entries.)_
