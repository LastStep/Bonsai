...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — `/home/user/Bonsai/Research/` does not exist on this machine; files were never tracked in git; existed on old machine path `/home/rohan/ZenGarden/Bonsai/`. Flagged 2026-06-17 memory-consolidation. User action needed: locate or reconstruct, or remove these references.)
