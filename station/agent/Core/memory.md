...
- **Foundational research docs** — Anchor for methodology/concept decisions. *(stale — station/Research/ directory does not exist; files were planned but never created. See Backlog Group D "[feature] Research scaffolding item + abilities". Re-add links when Research/ scaffolding ships.)*
