...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — `Research/` directory not found in repo as of 2026-08-29; paths below likely removed or never committed; verify before citing)
