...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — `station/Research/` directory missing as of 2026-06-10; files were untracked and not in git history. May have been on a prior machine. Flag for user: verify if files exist elsewhere or can be recovered.)
    ...
    - [Research/RESEARCH-eval-system.md](../../Research/RESEARCH-eval-system.md) — Eval system concept: scenarios, evaluators, benchmarks (stale — file missing; referenced in Plan 38 archived to Bonsai-Eval)
