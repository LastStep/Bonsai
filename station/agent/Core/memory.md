...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — `station/Research/` directory no longer exists as of 2026-07-17 consolidation check; files absent from repo. Entries kept for audit trail. Verify if relocated before removing.)
