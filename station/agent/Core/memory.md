...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — Research/ directory does not exist in repo as of 2026-09-04 memory-consolidation audit; files may have been deleted or never committed. Remove this block if Research/ is not restored.)
