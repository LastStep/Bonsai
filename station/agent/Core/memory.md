...
- [CLEANUP] Plan 41 (`41-headless-cli-contract.md`) still in Plans/Active/ — archive to Plans/Archive/ (pending since Plan 41 shipped 2026-06-16; 3+ months elapsed without action).
...
- **Foundational research docs** — Anchor for methodology/concept decisions. (stale — `/home/user/Bonsai/Research/` directory not found as of 2026-09-19; files may have been deleted or never committed; verify with user)
