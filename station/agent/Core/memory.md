...
**Current task:** Plan 22 — `bonsai init` cinematic redesign. Phases 1–3 shipped 2026-04-21 (PRs #47 `7553d43`, #48 `2e2a08c`, #49 `971ee44`). Next: Phase 4 (Branches tabbed picker + inline-expand — replaces Branches stub with real tabbed category picker per `zen-shell.jsx` ZStepBranches).
**In flight (other tracks):** None.
**Blocked on:** Nothing.
**Loose ends (uncommitted):** Plan 22 Phase 3 refinement edits to `station/Playbook/Plans/Active/22-init-redesign.md` — pending chore commit.
