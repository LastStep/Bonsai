...
- **Foundational research docs** — Anchor for methodology/concept decisions. *(stale — `station/Research/` directory not found in repo as of 2026-07-05; files were never committed or have been deleted; entries preserved for reference intent)*
