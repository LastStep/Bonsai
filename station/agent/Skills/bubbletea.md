...
**CRITICAL**: Before implementing ANY layout, consult `bubbletea/golden-rules.md` for the 4 Golden Rules. These rules prevent the most common and frustrating TUI layout bugs.
...
Full details and examples in `bubbletea/golden-rules.md`.
...
See `bubbletea/components.md` for the complete catalog of reusable components:
...
See `bubbletea/troubleshooting.md` for detailed solutions to common issues:
...
See `bubbletea/troubleshooting.md` for the complete debugging decision tree.
...
- **bubbletea/golden-rules.md** - Critical layout patterns and anti-patterns
- **bubbletea/components.md** - Complete catalog of reusable components
- **bubbletea/troubleshooting.md** - Common issues and debugging decision tree
- **bubbletea/emoji-width-fix.md** - Battle-tested solution for emoji alignment across terminals (xterm, WezTerm, Termux, Windows Terminal)
